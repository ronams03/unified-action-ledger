...
```bash
git remote add encore encore://unified-action-ledger-382i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/unified-action-ledger-382i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/unified-action-ledger-382i/settings/integrations/github)
